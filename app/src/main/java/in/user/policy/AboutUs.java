...
public class AboutUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        if (AppConstants.isInternetAvailable(AboutUs.this)) {
            privacy_policy();
        } else {
    ...
    public void init() {
        ...
        textToolHeader.setText("About Us");
        setSupportActionBar(toolBar);
...
//        }
    ...
    public void privacy_policy() {
        ...
        //https://opark.in/O_par_aPi/userapp/live/index.php/v1/page/content?pageName=about_us
        String urlData = AppConstants.BASEURL + "page/content?pageName=about_us";
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        if (AppConstants.isInternetAvailable(AboutUs.this) && !AppConstants.isBlank(receipt)) {
                            showProgressDialog();
