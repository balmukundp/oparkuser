...
public class TERMSANDCONDITIONS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        if (AppConstants.isInternetAvailable(TERMSANDCONDITIONS.this)) {
            privacy_policy();
        } else {
    ...
    public void init() {
        ...
        textToolHeader.setText("TERMS AND CONDITIONS");
        setSupportActionBar(toolBar);
...
//        }
    ...
    public void privacy_policy() {
        final ProgressDialog progressDialog = new ProgressDialog(TERMSANDCONDITIONS.this);
        progressDialog.show();
        progressDialog.setMessage("Loading...");
        progressDialog.setIndeterminate(true);
        progressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        progressDialog.setContentView(R.layout.custom_progress_bar);
        //https://opark.in/O_par_aPi/userapp/live/index.php/v1/page/content?pageName=term_condition
        String urlData = AppConstants.BASEURL + "page/content?pageName=term_condition";
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        if (AppConstants.isInternetAvailable(TERMSANDCONDITIONS.this) && !AppConstants.isBlank(receipt)) {
                            showProgressDialog();
