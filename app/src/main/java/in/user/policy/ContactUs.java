...
public class ContactUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        if (AppConstants.isInternetAvailable(ContactUs.this)) {
            privacy_policy();
        } else {
    ...
    public void init() {
        ...
        textToolHeader.setText("Contact Us");
        setSupportActionBar(toolBar);
...
//        }
    ...
    public void privacy_policy() {
        ...
        String urlData = AppConstants.BASEURL + "page/content?pageName=contactus";
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        if (AppConstants.isInternetAvailable(ContactUs.this) && !AppConstants.isBlank(receipt)) {
                            showProgressDialog();
